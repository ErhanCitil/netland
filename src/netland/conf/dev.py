...
os.environ.setdefault(
    "SECRET_KEY",
    "django-insecure-a51_t&!%&+7a8km-21((u4hybyv6t_s5=lo=#u&3d-luc0z^)y",
)
os.environ.setdefault("IS_HTTPS", "no")
os.environ.setdefault("VERSION_TAG", "dev")

os.environ.setdefault("DB_NAME", "netland")
os.environ.setdefault("DB_USER", "netland")
os.environ.setdefault("DB_PASSWORD", "netland")
