...
class SerieTestCase(TestCase):
    def setUp(self):
        Series.objects.create(
            ...
            rating=9.0,
            summary="A group of survivors travel through a post-apocalyptic world, holding on to the hope of humanity by banding together to fight against the zombies that threaten their lives.",
            has_won_awards=1,
            seasons=10,
            country="US",
            spoken_in_language="EN",
        )
        Series.objects.create(
            title="Breaking Bad",
            rating="9.5",
        ...
        Series.objects.create(
            ...
            rating="9.3",
            summary="Nine noble families fight for control over the mythical lands of Westeros, while a forgotten",
            has_won_awards="1",
            seasons="8",
            country="US",
            spoken_in_language="EN",
    ...
    def test_summary(self):
        serie = Series.objects.get(
            summary="A group of survivors travel through a post-apocalyptic world, holding on to the hope of humanity by banding together to fight against the zombies that threaten their lives."
        )
        self.assertEqual(
            serie.summary,
            "A group of survivors travel through a post-apocalyptic world, holding on to the hope of humanity by banding together to fight against the zombies that threaten their lives.",
        )
