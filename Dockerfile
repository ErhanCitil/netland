...
COPY --from=frontend-build /app/src/netland/static /app/src/netland/static
...
LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://bitbucket.org/maykinmedia/netland" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="netland"
